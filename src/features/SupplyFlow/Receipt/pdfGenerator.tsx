...
export const pdfGenerator = async (
  ...
  const materialName = recieptData?.orderDetails[0]?.categoryName;
  ...
  <body>
            ...
            >
              <div style="box-sizing: border-box">
                ...
                <span class="fw-bolder text-dark" style="box-sizing: border-box"
                  >${franchiseeName ?? "N/A"}</span
                >
              </div>
              <div style="box-sizing: border-box">
                ID :
                <span class="fw-bolder text-dark" style="box-sizing: border-box"
                  >${franchiseeId ?? "N/A"}</span
                >
              </div>
            </div>
            <div
                ...
                <table>
                  <tr>
                    ...
                    <td style="text-align: left">${
                      recieptData?.pickupPointName ?? "N/A"
                    }</td>
                  </tr>
                  ...
                  <tr>
                    ...
                    <td colspan="2" style="text-align: left">
                      ${recieptData?.pickupInfo?.address?.latitute ?? "N/A"},
                      ${recieptData?.pickupInfo?.address?.longitute ?? "N/A"}
                    </td>
                  </tr>
                </table>
              </td>
    ...
    if (Platform.OS === "android") {
      ...
      let filePath =
        ...
        `/Enverify/Invoice_supply_${recieptData?.id}.pdf`;
    ...
    if (Platform.OS === "ios") {
      try {
        const options = {
          html,
          fileName: `Invoice_supply_${recieptData?.id}`,
          directory: "Documents",
          base64: true,
        };
